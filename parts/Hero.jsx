function Hero() {
  return (
    <section style={{
      ...
      {/* top — small ornament */}
      <div className="hero-anim d-1" style={{
        position: 'relative', zIndex: 2, textAlign: 'center'
      }}>
        <span style={{ display: 'inline-block', width: 1, height: 24, background: 'var(--whisper)' }} />
      </div>

      {/* full-bleed portrait — breaks out of the section padding so the photo runs edge-to-edge */}
      <div className="hero-anim d-2" style={{
        ...
        <img src="assets/couple.png" alt="Артём и Олеся" style={{
          width: '100%', height: '100%',
          objectFit: 'cover',
          objectPosition: 'center 28%',
          display: 'block',
          filter: 'saturate(0.82) contrast(1.0)',
          WebkitMaskImage: 'linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.4) 8%, black 26%, black 70%, rgba(0,0,0,0.4) 92%, transparent 100%)',
          maskImage: 'linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.4) 8%, black 26%, black 70%, rgba(0,0,0,0.4) 92%, transparent 100%)'
        }}/>
      </div>

      {/* center — names */}
      <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 22 }}>
        <div className="hero-script d-3" style={{
          fontFamily: 'var(--font-script)',
          color: 'var(--graphite)',
          lineHeight: 1, letterSpacing: '0.02em', fontSize: '40px'
        }}>
          wedding day
        </div>

        <h1 className="hero-anim d-4" style={{
          fontFamily: 'var(--font-display)',
          lineHeight: 0.95,
          letterSpacing: '0.02em',
          textTransform: 'uppercase',
          color: 'var(--charcoal)',
          margin: 0, fontWeight: '500', fontSize: 'clamp(48px, 14vw, 64px)'
        }}>
          АРТЁМ<br />
          <span style={{
        ...
        <div className="hero-date d-5" style={{
          fontFamily: 'var(--font-display)',
          fontSize: 22,
          color: 'var(--charcoal)',
          fontWeight: 400,
      ...
      <div className="hero-anim d-5" style={{
        ...
        <span style={{ display: 'inline-block', width: 1, height: 28, background: 'var(--whisper)' }} />
      </div>
    </section>);
